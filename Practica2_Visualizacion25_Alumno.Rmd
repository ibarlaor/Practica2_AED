...
grafico2
grafico3 <- grafico2 + ggtitle('Máxima temperatura frente a mínima temperatura')
grafico3
...
ggplot(data=ds, aes(x=Temp9am, y=Pressure9am)) + geom_point(aes(shape=RainToday))
ggplot(data=ds, aes(x=Temp9am, y=Pressure9am)) + geom_point(aes(color=RainToday))
ggplot(data=ds, aes(x=Temp9am, y=Pressure9am)) + geom_point(aes(color=RainToday)) + labs(title = "Presión frente a temperatura", subtitle = "A 9am", x = "Temperatura (ºC)", y = "Presión (unidades)")
...
str(iris.tidy)
iris.grafico1 <- ggplot(data=iris.tidy, mapping=aes(x=Species, y=Value)) + geom_point()
iris.grafico2 <- ggplot(data=iris.tidy, mapping=aes(x=Species, y=Value)) + geom_point(aes(color=Part))
iris.grafico3 <- iris.grafico2 + facet_grid(Part~.)
iris.grafico4 <- iris.grafico2 + facet_grid(.~Part)
iris.grafico5 <- ggplot(data=iris.tidy, mapping=aes(x=Species, y=Value)) + geom_jitter(aes(color=Part))
iris.grafico5 + facet_grid(.~Part)
...
grafico1
grafico2 <- grafico1 + geom_line(aes(linetype='solid'))
grafico2
grafico3 <- grafico1 + geom_line(aes(linetype=Fabricante)) + ggtitle('Ventas mensuales de diferentes compañías tecnológicas')
grafico3
...
grafico1 <- ggplot(data=Experimento, aes(x=Dosis, y=Altura, linetype=Complemento, shape=Complemento)) + geom_point() + geom_line()
grafico1
grafico2 <- grafico1 + geom_errorbar(aes(ymin=Altura-Error_Altura, ymax=Altura+Error_Altura))
grafico2
grafico3 <- ggplot(data=Experimento, aes(x=Dosis, y=Altura)) + geom_point(aes(shape=Complemento)) + geom_line(aes(linetype = Complemento)) +  geom_errorbar(aes(ymin=Altura-Error_Altura, ymax=Altura+Error_Altura, linetype=Complemento)) +  theme_classic() +  scale_color_brewer(palette='Reds')
grafico3
```
...
ggplot(data=ice.river.df, aes(x=time))+geom_point(aes(y=flow.vat), color='red')+geom_point(aes(y=flow.jok), color='blue') + labs(title='Caudal de ambos ríos a lo largo del tiempo', x='Tiempo (años)', y='Caudal') + theme_classic()
...
grafico1 <- ggplot(data=ds, aes(x=Year)) + geom_boxplot(aes(y=MinTemp))
grafico1
grafico2 <- ggplot(data=ds, aes(x=Year)) + geom_violin(aes(y=MaxTemp, fill=Year)) + labs(title='Gráficos de violín de temperatura máxima para cada año', x='Año', y='Temperatura (ªC)')
grafico2
grafico3 <- grafico2 + theme(legend.position = 'none') # eliminar leyenda
grafico3
