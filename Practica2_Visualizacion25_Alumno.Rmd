...
grafico1 <- ggplot(data=ds, aes(x=Temp9am, y=Pressure9am))+geom_point(aes(shape=RainToday))
grafico2 <- ggplot(data=ds, aes(x=Temp9am, y=Pressure9am))+geom_point(aes(color=RainToday))
grafico3 <- grafico2 + labs(title = "Presión 9am frente a temperatura 9am", subtitle = "", x = "Temperatura", y = "Presión")
grafico3
...
grafico1 <- ggplot(data=DatosEjer4, aes(x=DatosEjer4$Fecha, y=DatosEjer4$Ventas, color=DatosEjer4$Fabricante))+geom_point()
grafico2 <- grafico1 + geom_line(aes(linetype=DatosEjer4$Fabricante))
...
ggplot(data=Experimento, aes(x=Dosis, y=Altura)) + geom_point()+geom_line(aes(linetype = Complemento))
```
